...
interface Props {
  onClose: () => void;
  onSave: (data: Novel) => Promise<void>;
}

const AddModal: React.FC<Props> = ({ onClose, onSave }) => {
          ...
          {columns.map((col) => (
            <div key={col.key} className="flex flex-col">
              ...
              {col.key === "tags" ? (
                ...
                <input
                  type="text"
                  value={addData[col.key as keyof typeof addData] as string}
